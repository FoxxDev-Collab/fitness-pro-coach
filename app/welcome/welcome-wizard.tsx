...
import { Compass, ArrowRight, ArrowLeft, Check, Loader2, AlertCircle } from "lucide-react";
...
import { completeOnboarding } from "@/lib/actions/coach-profile";
...
export function WelcomeWizard(props: WizardProps) {
  ...
  const step2Valid = !!timezone && timezone.trim().length > 0;
  ...
  function next() {
    ...
    if (step === 2 && !step2Valid) {
      setError("Please set your timezone.");
      return;
    }
